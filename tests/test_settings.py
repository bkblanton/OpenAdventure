...
def test_default_settings_are_accuracy_first():
    # The default table: GPT-6 Sol, high effort, thinking on (no presets).
    s = GenerationSettings()
    assert s.model == "gpt-6-sol"
...
def test_high_effort_settings_are_accuracy_first_and_separate_from_the_table():
    ...
    # even though it runs the same GPT-6 Sol the table does. It stays on the
    ...
    assert HIGH_EFFORT_SETTINGS.model == "gpt-6-sol"
